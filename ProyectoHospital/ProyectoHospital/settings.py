"""
Django settings for ProyectoHospital project - Configuración para desarrollo local.
"""
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Desactivar verificación de email para desarrollo
